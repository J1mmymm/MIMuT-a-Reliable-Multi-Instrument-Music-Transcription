...
def transcribe(
    ...
    long_context: Annotated[
        ...
        typer.Option(
            "--long-context",
            help=(
                "State policy across 5-second chunks: auto (carry for "
                "Hybrid-Mamba, reset for legacy Transformer), carry, reset, "
                "or clean_audio."
            ),
        ),
    ] = "auto",
    committed_symbolic_state: Annotated[
        ...
        typer.Option(
            ...
            help=(
                "Encode the transactionally committed active-note/program state "
                "into the temporary clean_audio decode branch."
            ),
        ),
    ] = False,
    auralize: Annotated[
